...
if __name__ == '__main__':
    ...
    for method in os.listdir(BASE):
        ...
        for hypers in  os.listdir(B1):
            ...
            run_str_eval = f'python eval_F_submission.py --data_dir {args.data_dir} --conf {conf} --match_th {match_th} --inlier_th {inl_th} --method {method} --split test --maxiter {maxiters}'
            ...
            OUT_DIR = get_output_dir('f', 'test', method, params)
